...
export function Field() {
    ...
    const updateHeight = () => {
        ...
        if (gameData.currentMonkeyClimbHeight >= 140) {
            document.documentElement.style.setProperty('--bg-offset', '0%');
        } else {
            let bgOffset = 70 - gameData.currentMonkeyClimbHeight / 2;
            document.documentElement.style.setProperty('--bg-offset', bgOffset + '%');
        }
